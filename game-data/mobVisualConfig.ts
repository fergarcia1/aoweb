...
export const MOB_VISUAL_CONFIGS: Record<MobModelId, MobVisualConfig> = {
  ...
  cracko: {
    ...
    path: "/assets/ao/imperium/mobs/npc_bodies/cracko.png",
    frameWidth: 64,
    frameHeight: 64,
    columns: 6,
    directionRows: MOB_DIRECTION_ROWS_SWAD,
    idleColumn: 0,
    walkFrames: [0, 1, 2, 3, 4, 5],
    scale: mobScaleForFrameHeight(64) * 1.05,
    notes: "384x256 SWAD, grilla 6x4.",
  },
  yeti: {
    type: "singleSheet",
    textureKeyPrefix: "yeti",
    path: "/assets/ao/imperium/mobs/npc_bodies/yeti.png",
    frameWidth: 150,
    frameHeight: 180,
    columns: 8,
    directionRows: MOB_DIRECTION_ROWS_SWAD,
    ...
    walkFrames: [0, 1, 2, 3, 4, 5, 6, 7],
    scale: 0.85,
    notes: "1200x720 SWAD, grilla 8x4. Escala equivalente a golem infernal.",
  },
  zombie: {
    type: "singleSheet",
    textureKeyPrefix: "zombie",
    path: "/assets/ao/imperium/mobs/npc_bodies/zombie.png",
    frameWidth: 24,
    frameHeight: 48,
    columns: 8,
    directionRows: MOB_DIRECTION_ROWS_SWAD,
  ...
  medusa: {
    type: "singleSheet",
    textureKeyPrefix: "medusa",
    path: "/assets/ao/imperium/mobs/npc_bodies/medusa.png",
    frameWidth: 128,
    frameHeight: 128,
    columns: 4,
    directionRows: MOB_DIRECTION_ROWS_SWAD,
  ...
  medusaM: {
    type: "singleSheet",
    textureKeyPrefix: "medusaM",
    path: "/assets/ao/imperium/mobs/npc_bodies/medusaM.png",
    frameWidth: 60,
    frameHeight: 75,
    columns: 8,
    directionRows: MOB_DIRECTION_ROWS_SWAD,
    idleColumn: 0,
    walkFrames: [1, 2, 3, 4, 5, 6, 7],
    mirrorRightFromLeft: false,
    scale: 0.85,
  },
};
