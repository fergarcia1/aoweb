...
function defaultScale(frameHeight: number, modelId: MobModelId): number {
  ...
  if (modelId === "golem_plata" || modelId === "golem_bronce" || modelId === "golem_hielo") {
    return base * 0.85;
  }
  return base;
}
