...
import { MOB_LARGE_TARGET_DISPLAY_HEIGHT_PX, mobScaleForFrameHeight } from "../../data/mobSheetLayouts";
...
/** Filas S W A D (convención por defecto). */
...
export const MOB_VISUAL_CONFIGS: Record<MobModelId, MobVisualConfig> = {
  ...
  ciclope: {
    ...
    walkFrames: [0, 1, 2, 3, 4, 5],
    walkColumnCountByFacing: { left: 5, right: 5 },
    scale: mobScaleForFrameHeight(128, MOB_LARGE_TARGET_DISPLAY_HEIGHT_PX) * 1.55,
